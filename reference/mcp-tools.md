...
3. use **caves__get_shadow_map** with their perspective id to explore their knowledge graph (if they've made it public)
...
4. use **caves__get_shadow_map** to see your full hierarchy
